...
use App\Services\BaiDu\Report\BaiDuAccountReportService;
use App\Services\Ocean\Report\OceanAccountReportService;

class BaiDuSyncAccountReportCommand extends BaseCommand
{
    /**
     * 命令行执行命令
     * @var string
     */
    protected $signature = 'baidu:sync_account_report  {--date=} {--account_ids=} {--delete=} {--running=} {--key_suffix=}';
     ...
     * @var string
     */
    protected $description = '同步百度账户报表';
    ...
    public function handle(){
        ...
        // 锁 key
        $lockKey = 'baidu_sync_account_report';
...
//        }
        ...
        $option = ['log' => true];
        $this->lockRun(
            [$baiduAccountReportService, 'sync'],
            $lockKey,
            43200,
            $option,
            $param
